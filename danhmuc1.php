        ...
        <article id="article-products">
            <div class="toolbar toolbar-products">
                <div class="filter-wrapper pull-left">
                    ...
                    <?php
                    // Lấy giá trị chất liệu từ query string
                    if (isset($_GET['chatlieu'])) {
                        $chatlieu = $_GET['chatlieu'];
                    }

                    // Xử lý khi người dùng chọn áp dụng
                    if (isset($_GET['filter']) && $_GET['filter'] === 'apply') {
                        // Thực hiện lọc sản phẩm theo chất liệu
                        $query_list_products = "SELECT * FROM tbl_sanpham WHERE chat_lieu = '$chatlieu'";
                        // Thực hiện truy vấn SQL và hiển thị danh sách sản phẩm tương ứng
                        // ...
                    } else {
                        // Hiển thị toàn bộ sản phẩm
                        $query_list_products = "SELECT * FROM tbl_sanpham";
                        // Thực hiện truy vấn SQL và hiển thị danh sách sản phẩm
                        // ...
                    }
                    ?>
                    ...
                    if (isset($_GET['iddm'])) {
                        ...
                        if ($iddm === 'tatca') {
                            ...
                            WHERE sp.chat_lieu IN (SELECT DISTINCT chat_lieu FROM tbl_sanpham)
                            ...
                            LEFT JOIN tbl_review rv ON sp.ma_san_pham = rv.ma_san_pham
                            LEFT JOIN tbl_danhmuc dm ON sp.ma_danh_muc = dm.ma_danh_muc
                            WHERE sp.ma_danh_muc = $iddm AND sp.chat_lieu IN (SELECT DISTINCT chat_lieu FROM tbl_sanpham WHERE ma_danh_muc = $iddm)
                            GROUP BY sp.ma_san_pham
                            ORDER BY RAND()
                            ";
                        }
                ...
                <div class="listing-title">
                    <a href="" class="listing-tile__link">
                        ...
                        <div class="listing-tile__content">
                            <p class="listing-tile__title">TẤT CẢ</p>
                        </div>
                    </a>
                </div>
                <!-- Day chuyen -->
